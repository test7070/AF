        ...
        <script type="text/javascript">
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)// 1-3
                    return;
                q_box('cng_af_s.aspx', q_name + '_s', "550px", "500px", q_getMsg("popSeek"));
            }
            ...
            function btnPrint() {
                q_box('z_cng_afp.aspx' + "?;;;;" + r_accy + ";noa=" + trim($('#txtNoa').val()), '', "95%", "95%", q_getMsg("popPrint"));
            }
            ...
            <div class="dbbm">
                <table class="tbbm"  id="tbbm">
                    ...
                    <tr class>
                        ...
                        <td class><input id="txtDatea" type="text" class="txt c1"/></td>
