    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function q_seekStr() {
                ...
                + q_sqlPara2("storinno", t_storinno);             
                if (t_comp.length>0)
                    t_where += " and charindex('" + t_comp + "',cust)>0";
                if(t_productno.length>0)
                    t_where += " and exists(select noa from cng"+r_accy+" where cngs"+r_accy+".noa=cng"+r_accy+".noa and cngs"+r_accy+".productno='"+t_productno+"')";
    ...
    >
        <div style='width:400px; text-align:center;padding:15px;' >
            <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
                ...
                <tr class='seek_tr'>
                    <td class='seek'  style="width:20%;"><a id='lblStorinno'> </a></td>
                    <td>
                    <input class="txt" id="txtStorinno" type="text" style="width:215px; font-size:medium;" />
                    </td>
                </tr>
            </table>
